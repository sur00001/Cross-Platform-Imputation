#Setting up Unfiltered Chr 22 train test data to match with C16 train/test split
...
load("C:/Users/Aparajita/Documents/genomePCs.rda")
...
pca.cov=rbind(pc.top,beta_450);beta_450=pca.cov
...
save(Unf.x_train,Unf.x_test,Unf.y_train,Unf.y_test,file=paste("Unfpc.testtrain22.rda"))
